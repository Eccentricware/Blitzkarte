    ...
    <div id="stall-globe-container">
      <svg id="stall-globe" width="500" height="500" viewBox="0 0 503 503">
        ...
        <line x1="251.5" y1="1.5" x2="251.5" y2="501.5" fill="none" strokeMiterlimit="10"
          ...
          strokeWidth={mode === 'authenticating' ? 9 : 3}
        />
        <path d="M38,117.42A25.13,25.13,0,0,0,34.38,130c0,38.22,96.54,69.21,215.62,69.21s215.62-31,215.62-69.21A25.13,25.13,0,0,0,462,117.42" transform="translate(1.5 1.5)" fill="none" strokeMiterlimit="10"
          stroke={mode !== 'error' ? 'green' : 'red'}
          strokeWidth={mode === 'querying' ? 9 : 3}
        />
        <path d="M500,250c0,44.32-111.93,80.25-250,80.25S0,294.32,0,250" transform="translate(1.5 1.5)" fill="none"
          strokeMiterlimit="10"
          stroke={mode !== 'error' ? 'green' : 'red'}
          strokeWidth={mode === 'querying' ? 9 : 3}
        />
        <path d="M31,370.56c19,33.29,109.83,58.53,219,58.53s200.05-25.24,219-58.53" transform="translate(1.5 1.5)"
          fill="none" strokeMiterlimit="10"
          stroke={mode !== 'error' ? 'green' : 'red'}
          strokeWidth={mode === 'querying' ? 9 : 3}
        />
        <path d="M130.78,30a14.1,14.1,0,0,0-2,7.08C128.77,58.52,183.05,76,250,76S371.23,58.52,371.23,37a14.1,14.1,0,0,0-2-7.08" transform="translate(1.5 1.5)" fill="none" strokeMiterlimit="10"
          stroke={mode !== 'error' ? 'green' : 'red'}
          strokeWidth={mode === 'querying' ? 9 : 3}
        />
      </svg>
