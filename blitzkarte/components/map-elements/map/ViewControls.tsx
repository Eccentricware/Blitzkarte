...
export const ViewControls: FC<ViewControlProps> = ({
  ...
  return (
    <svg width="1500" height="1500" viewBox="0 0 502.24 502.24">
      <g id="Globe" className="map-view-button" onClick={handleViewReset}>
        <circle cx="251.12" cy="251.12" r="109.83" fill="aqua" stroke="black" strokeMiterlimit="10" strokeWidth={5}/>
