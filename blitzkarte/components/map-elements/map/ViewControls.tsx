...
export const ViewControls: FC = () => {
  ...
  return (
    <svg width="1500" height="1500" viewBox="0 0 502.24 502.24">
      <g id="Globe" onClick={handleViewReset}>
      ...
      <g id="Zoom_Out" data-name="Zoom Out" onClick={() => handleZoomOut()}>
      ...
      <g id="Zoom_In" data-name="Zoom In" onClick={handleZoomIn}>
      ...
      <g id="Pan_Right" data-name="Pan Right" onClick={handlePanRight}>
      ...
      <g id="Pan_Left" data-name="Pan Left" onClick={handlePanLeft}>
      ...
      <g id="Pan_Down" data-name="Pan Down" onClick={handlePanDown}>
      ...
      <g id="Pan_Up" data-name="Pan Up" onClick={handlePanUp}>
